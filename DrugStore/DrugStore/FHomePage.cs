...
namespace DrugStore
{
    public partial class FHomePage : Form
    {
        ...
        {
            khoThuocList.DataSource = BUS.ThuocBUS.Instance.thongKeThuocTrongKho(0, 30);
        }

        private void btn_thuoc3t_Click(object sender, EventArgs e)
        {
            khoThuocList.DataSource = BUS.ThuocBUS.Instance.thongKeThuocTrongKho(0, 90);
        ...
        void stateLanguage(bool isVN)
        {
            if (isVN)
            {
                ...
                btn_bcdoanhthu.Text = "Quản lý doanh thu";
                ...
                btn_thuocHH.Text = "Thuốc còn hạn 6 tháng";
            ...
            else
            {
                ...
                btn_bcdoanhthu.Text = "Revenue Management";
                ...
                btn_thuocHH.Text = "6 months expired medicine";
                ...
                dgv_dsthuoc.Columns[4].HeaderText = "Packing Specification";
                ...
                btn_thuocbanchay.Text = " Best sellers of the month";
                ...
                lb_batdaubc.Text = "Start Date";
                lb_ketthucbc.Text = "End Date";
                ...
                btn_doimk.Text = "Change Password";
            }
        }
